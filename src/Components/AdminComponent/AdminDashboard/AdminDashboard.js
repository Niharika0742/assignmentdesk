    ...
    import TeacherRegistration from "./TeacherList/TeacherRegistration";
    import TeacherProfile from "./TeacherList/TeacherProfile";
    import Teacheredit from "./TeacherList/Teacheredit";
            ...
            <div id={style.headerHeadingBox}>
             ...
             <div id={style.headerMenuBox}>
                           <NavLink exact to="/AdminDashboard"> <span> Home</span> </NavLink>
                            ...
                            <NavLink exact className={style.removeUnderline} to="/AdminDashboard/TeacherList"><span>  Teachers </span></NavLink>
        ...
        <div id={style.box}>
            ...
            <div id={style.display}>
                      <Switch>
                          ...
                          <Route exact path="/AdminDashboard/TeacherList" component={TeacherList}></Route>
                          <Route exact path="/AdminDashboard/TeacherRegistration" component={TeacherRegistration}></Route>
                          <Route exact path="/AdminDashboard/Teacheredit/:id" component={Teacheredit}></Route>
                          <Route exact path="/AdminDashboard/TeacherProfile/:id" component={TeacherProfile}></Route>
